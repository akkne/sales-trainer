...
### [ ] W-3 Теоретический урок: провал отправки карточек не показывается и оставляет урок наполовину зачтённым
...
### [ ] W-5 Диалоговый тренажёр: при отказе отправки реплика пользователя остаётся в стенограмме
...
### [ ] W-13 Онбординг: выбранные навыки записываются «по возможности», отказ проглатывается пустым `catch`
