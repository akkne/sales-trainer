...
### [x] R2-10 вывод разблокировки X-11 сделан только в одном из трёх путей чтения уроков
...
### [x] R2-12 корневой `not-found.tsx` стал клиентским; на 404 внутри `/admin` мигает ученическая русская копия
