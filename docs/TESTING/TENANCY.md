...
Цифры прогона 2026-08-18: learning 67/67, ai 170/170, organization 68/68, оба линта чистые,
`tsc` без ошибок. **Ни один из этих тестов не проверяет ничего из 40.19** — они гарантируют только,
