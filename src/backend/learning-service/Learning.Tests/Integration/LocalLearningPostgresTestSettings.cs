...
/// (<see cref="LearningTenantIsolationIntegrationTests"/>), deliberately mirroring
/// <c>BuildingBlocks.Tests/Tenancy/Support/LocalPostgresTestSettings</c>: same defaults
...
/// BuildingBlocks fixture's so the two can run in the same session without fighting over a
/// database name. Neither ever touches the real <c>learning</c> database.
/// </para>
/// </summary>
internal static class LocalLearningPostgresTestSettings
{
    ...
    public const string TestDatabaseName = "learning_tenancy_integration_test";
    public const string ApplicationRoleName = "sellevate_learning_app_test";
    public const string ApplicationRolePassword = "learning_tenancy_test_only_password";
