    ...
    ILogger<AvatarService> logger) : IAvatarService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Other services keep an avatar key in their UserReplica; tell them it changed.
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Reset back to a generated default avatar — replicas should drop the stored key.
        await userEventPublisher.PublishAvatarChangedAsync(
