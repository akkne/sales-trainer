...
/// <c>OrgAdmin</c> of a brand new organization.
///
/// <para>
/// There is deliberately no role field: this endpoint only ever issues an <c>OrgAdmin</c> invite.
...
/// an active <c>OrgAdmin</c> or a pending <c>OrgAdmin</c> invite, so it cannot be used as a back
