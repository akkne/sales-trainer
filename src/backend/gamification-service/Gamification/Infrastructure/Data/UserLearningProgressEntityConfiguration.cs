...
/// <summary>
/// Phase 40.13: the key is composite. A user id alone stopped identifying a row the moment a person
/// could belong to two customers (memberships, 40.6) — one of the two organizations would have
/// silently overwritten the other's counters.
/// </summary>
