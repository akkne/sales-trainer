        ...
        <>
            <aside className="w-64 bg-gray-50 border-r border-gray-200 flex flex-col h-full">
                <div className="p-4 border-b border-gray-200 flex gap-2">
                    <button
                        onClick={onClose}
                        className="py-2 px-3 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-colors text-xl"
                        aria-label="Закрыть"
                    >
                        &times;
                    </button>
                                ...
                                >
                                    <div className="flex items-start gap-2">
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {session.status === "completed" && session.xpEarned > 0 && (
                                                    <span className="text-xs text-[#58CC02] font-semibold flex-shrink-0">
                                                        +{session.xpEarned} XP
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        <button
                                            ...
                                            className="text-gray-300 hover:text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity text-lg self-center flex-shrink-0"
