...
function renderModal(onClose = vi.fn()) {
    ...
    return {
        ...
        submit: () => screen.getByText("Начать разговор") as HTMLButtonElement,
    };
}
...
describe("CustomScenarioModal", () => {
    ...
    it("keeps the submit button disabled until the scenario is long enough", () => {
    ...
    it("starts a session with the scenario and opens the conversation", async () => {
