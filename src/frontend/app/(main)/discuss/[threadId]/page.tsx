    ...
    const submitReply = async () => {
        ...
        if (filesToUpload.length > 0) {
            try {
                ...
                setReplyError("Ответ опубликован, но не удалось загрузить фото");
            }
        }
    };
        ...
        <div className="page">
            <div className="container" style={{ maxWidth: 860 }}>
                ...
                <article className="dsc-detail-thread">
                    ...
                    <div className="dsc-detail-body">
                        ...
                        <div className="dsc-badges">
                            ...
                            {thread.isHot    && <span className="dsc-badge hot">Популярное</span>}
                        </div>
                                ...
                                <div className="dsc-reply-meta">
                                    ...
                                    {canModerate && (
                                        ...
                                        >
                                            ...
                                            {reply.isAccepted ? "Снять отметку" : "Отметить как решение"}
                                        </button>
                                    )}
                                </div>
                            </div>
                ...
                <div className="dsc-composer">
                    <span className="dsc-composer-label">Твой ответ</span>
                    <Textarea
                        placeholder="Поделись опытом или скриптом…"
                        value={replyBody}
                        rows={4}
