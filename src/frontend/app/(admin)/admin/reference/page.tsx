        ...
        <div>
            ...
            {showCreateForm && (
                <div className="bg-surface rounded-2xl border border-line p-5 mb-6 space-y-4">
                    <h2 className="text-sm font-semibold text-ink">Create material</h2>
            ...
            <div className="flex flex-wrap gap-3 mb-5">
                <input
                    ...
                    className="border border-line rounded-md px-3 py-1.5 text-sm w-56 focus:outline-none focus:ring-1 focus:ring-indigo/30"
                />
                <select
            ...
            {isLoading ? (
                ...
                <div className="space-y-4">
                    {materials.map((material) => (
                        <div key={material.id} className="bg-surface rounded-2xl border border-line p-5">
                            {editingId === material.id ? (
                                ...
                                <div>
                                    <div className="flex items-start justify-between mb-2">
                                        <div>
                                            <h3 className="font-medium text-ink">{material.title}</h3>
                                            <div className="flex flex-wrap gap-2 mt-1">
                                                ...
                                                <span className="text-xs text-ink-3">order: {material.sortOrder}</span>
                                            </div>
                                        </div>
                                    ...
                                    <pre className="text-xs text-ink-3 font-mono whitespace-pre-wrap line-clamp-3 bg-surface rounded p-3 mt-2">
